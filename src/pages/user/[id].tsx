                ...
                <div className='flex justify-start border-b-4'>
                    <div className='flex py-5'>
                        ...
                        <div className='flex flex-col justify-center px-4'>
                            <h1 className='text-2xl font-bold text-gray-800 hover:text-gray-600'>{data.company.title}</h1>
                            <span className='text-sm text-gray-500'>{data.company.department + ' Department'}</span>
                        </div>
                    </div>
                </div>
                    <div className='staffInfo border-b-4 pb-10 '>
                    <h1 className="text-2xl font-bold flex justify-center bg-red-200 py-4">User Info</h1>
